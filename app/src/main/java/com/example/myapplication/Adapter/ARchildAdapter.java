...
public class ARchildAdapter extends RecyclerView.Adapter<ARchildAdapter.Viewholder> {

    Context context;
    ArrayList<AdminRmodel> arrayList;

    public ARchildAdapter(Context context, ArrayList<AdminRmodel> arrayList) {
    ...
    @NonNull
    @Override
    public ARchildAdapter.Viewholder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        return new ARchildAdapter.Viewholder(LayoutInflater.from(context).inflate(R.layout.adminreportlayout,parent,false));
    }

    @Override
    public void onBindViewHolder(@NonNull ARchildAdapter.Viewholder holder, int position) {
